...
def focallength(s_two):
    ...
    -s_two is a positive non-zero float, and is the distance from the Fourier lens to the focal plane in m. The SLM is positioned 0.55m from the Fourier lens"""
